          ...
          <div className="overflow-x-auto overflow-y-hidden custom-scrollbar">
            <table className="w-full text-left min-w-[500px]">
              <thead className="bg-gray-50/50 border-b border-gray-100">
                <tr>
                  <th className="px-4 py-2.5 text-[9px] font-bold text-gray-400 uppercase tracking-widest">Transaction ID</th>
                  <th className="px-4 py-2.5 text-[9px] font-bold text-gray-400 uppercase tracking-widest text-center">Method</th>
                  <th className="px-4 py-2.5 text-[9px] font-bold text-gray-400 uppercase tracking-widest text-right">Amount</th>
                  <th className="px-4 py-2.5 text-[9px] font-bold text-gray-400 uppercase tracking-widest text-right">Status</th>
                </tr>
              </thead>
                ...
                {payments.length > 0 ? payments.map((payment) => (
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-10 text-center">
                       <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest">No payments recorded</p>
                    </td>
                  </tr>
                )}
              </tbody>
