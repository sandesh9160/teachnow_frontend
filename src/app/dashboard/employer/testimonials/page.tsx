    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-12 px-4 md:px-0">
      <div className="flex items-center justify-between gap-4 border-b border-slate-100 pb-6">
        <div>
          ...
          <p className="text-slate-500 font-bold text-[10px] uppercase tracking-widest mt-0.5">Manage your platform feedback</p>
        </div>
      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-slate-200 p-6 animate-in fade-in slide-in-from-top-4 duration-500">
          <h2 className="text-lg font-bold text-slate-900 mb-6 flex items-center gap-2">
            ...
            {editingId ? "Update Testimonial" : "Post New Feedback"}
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 max-w-xl">
            ...
            <div className="space-y-3">
              <Label className="text-slate-900 font-extrabold text-[10px] uppercase tracking-widest pl-0.5">Your Rating</Label>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {testimonials.map((t) => (
            <div key={t.id} className="flex flex-col bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden hover:border-primary/20 group relative transition-all duration-300">
               {/* Action Strip */}
