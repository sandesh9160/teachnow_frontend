      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
        ...
        <div className="relative w-full lg:max-w-xs">
          ...
          <Input
            ...
            className="h-10 pl-10 bg-white border border-slate-300 rounded-xl text-[12.5px] font-medium focus:ring-1 focus:ring-indigo-100 shadow-xs border"
          />
        </div>
      </div>
      ...
      <div className="space-y-3">
        {filteredJobs.length > 0 ? (
          ...
          <div className="bg-white rounded-3xl border border-dashed border-slate-200 py-16 flex flex-col items-center justify-center text-center gap-5">
            ...
            <Link href={`${basePath}/post-job`}>
              <Button className="h-11 px-7 rounded-xl font-semibold text-xs bg-[#312E81] hover:bg-[#1E1B4B] border border-[#312E81] hover:border-[#1E1B4B] text-white shadow-sm transition-all">
                Post a new job
              </Button>
            </Link>
          </div>
