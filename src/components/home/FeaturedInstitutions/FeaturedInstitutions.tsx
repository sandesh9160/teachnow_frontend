      ...
      <div className="max-w-none w-full">
        ...
        <div className="relative group/carousel">
          ...
          <button 
            ...
            className="absolute left-5 md:-left-4 top-[40%] -translate-y-1/2 z-50 h-9 w-9 md:h-11 md:w-11 rounded-full bg-white shadow-[0_4px_12px_rgba(0,0,0,0.1)] border border-slate-100 text-[#1e3a8a] flex items-center justify-center active:scale-90 transition-all"
          >
          ...
          <button 
            ...
            className="absolute right-5 md:-right-4 top-[40%] -translate-y-1/2 z-50 h-9 w-9 md:h-11 md:w-11 rounded-full bg-white shadow-[0_4px_12px_rgba(0,0,0,0.1)] border border-slate-100 text-[#1e3a8a] flex items-center justify-center active:scale-90 transition-all"
          >
