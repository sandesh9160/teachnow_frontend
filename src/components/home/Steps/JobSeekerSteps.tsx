      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map((s) => (
            <div
              key={s.step}
              className="group rounded-2xl border border-border bg-background p-6 shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 text-center"
            >
              <div className="mx-auto mb-4 h-36 w-36 overflow-hidden rounded-xl">
                <img
                  src={s.img}
                  alt={s.title}
              ...
              <div className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold mb-3">
                {s.step}
              </div>
